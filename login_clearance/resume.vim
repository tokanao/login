...
set noequalalways
set errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/login_clearance
set expandtab
...
silent only
cd ~/rails_work/login/login_clearance
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +48 ~/rails_work/login/login_sorcery/Gemfile
badd +31 ~/rails_work/login/login_sorcery/config/database.yml
badd +5 ~/rails_work/login/login_sorcery/app/controllers/application_controller.rb
badd +1 ~/rails_work/login/login_sorcery/app/models/user.rb
badd +17 ~/rails_work/login/login_sorcery/config/Schemafile
badd +5 ~/rails_work/login/login_sorcery/db/migrate/20170302003823_sorcery_core.rb
badd +11 ~/rails_work/login/login_sorcery/app/controllers/users_controller.rb
badd +1 ~/rails_work/login/login_sorcery/app/views/layouts/application.html.erb
badd +2 ~/rails_work/login/login_sorcery/app/views/users/destroy.html.slim
badd +18 ~/rails_work/login/login_sorcery/app/views/users/_form.html.slim
badd +1 ~/rails_work/login/login_sorcery/app/models/user_session.rb
badd +1 ~/rails_work/login/login_sorcery/app/controllers/user_sessions_controller.rb
badd +4 ~/rails_work/login/login_sorcery/app/views/user_sessions/new.html.slim
badd +1 ~/rails_work/login/login_sorcery/app/views/user_sessions/_form.html.erb
badd +2 ~/rails_work/login/login_sorcery/app/views/user_sessions/new.html
badd +1 ~/rails_work/login/login_sorcery/config/routes.rb
badd +1 ~/rails_work/login/login_sorcery/app/views/user_sessions/new.html.erb
badd +4 ~/rails_work/login/login_sorcery/app/views/users/new.html.slim
badd +1 ~/rails_work/login/login_sorcery/app/views/users/index.html.slim
badd +0 ~/rails_work/login_sorcery/app/views/users/new.html.slim
badd +0 ~/rails_work/login_sorcery/app/controllers/users_controller.rb
badd +0 ~/rails_work/login_sorcery/app/models/user.rb
badd +0 ~/rails_work/login_sorcery/app/views/user_sessions/_form.html.erb
badd +0 ~/rails_work/login_sorcery/app/views/user_sessions/new.html.erb
badd +0 ~/rails_work/login_sorcery/app/controllers/user_sessions_controller.rb
badd +0 ~/rails_work/login_sorcery/app/models/user_session.rb
badd +49 Gemfile
badd +26 config/database.yml
badd +2 app/controllers/application_controller.rb
badd +1 app/models/user.rb
badd +31 config/environments/development.rb
badd +1 app/views/layouts/application.html.erb
badd +1 config/initializers/clearance.rb
badd +1 app/controllers/dashboards_controller.rb
badd +3 config/routes.rb
badd +2 app/views/dashboards/show.html.slim
badd +14 vendor/bundle/ruby/2.2.0/gems/clearance-1.16.0/app/controllers/clearance/users_controller.rb
badd +7 vendor/bundle/ruby/2.2.0/gems/clearance-1.16.0/app/views/users/_form.html.erb
badd +1 ~/rails_work/login_clearance/app/views/users/new.html.erb
argglobal
silent! argdel *
set stal=2
edit ~/rails_work/login/login_sorcery/app/views/layouts/application.html.erb
...
setlocal nodiff
setlocal equalprg=
setlocal errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/login_sorcery
setlocal expandtab
if &filetype != 'eruby'
...
setlocal path=~/rails_work/login_sorcery/lib,~/rails_work/login_sorcery/vendor,~/rails_work/login_sorcery/app/models/concerns,~/rails_work/login_sorcery/app/controllers/concerns,~/rails_work/login_sorcery/app/controllers,~/rails_work/login_sorcery/app/helpers,~/rails_work/login_sorcery/app/mailers,~/rails_work/login_sorcery/app/models,~/rails_work/login_sorcery/app/jobs,~/rails_work/login_sorcery/app/*,~/rails_work/login_sorcery/app/views,~/rails_work/login_sorcery/app/views/application,~/rails_work/login_sorcery/public,~/rails_work/login_sorcery/test,~/rails_work/login_sorcery/test/unit,~/rails_work/login_sorcery/test/functional,~/rails_work/login_sorcery/test/integration,~/rails_work/login_sorcery/test/controllers,~/rails_work/login_sorcery/test/helpers,~/rails_work/login_sorcery/test/mailers,~/rails_work/login_sorcery/test/models,~/rails_work/login_sorcery/test/jobs,~/rails_work/login_sorcery/vendor/plugins/*/lib,~/rails_work/login_sorcery/vendor/plugins/*/test,~/rails_work/login_sorcery/vendor/rails/*/lib,~/rails_work
...
wincmd w
argglobal
edit ~/rails_work/login/login_sorcery/app/controllers/application_controller.rb
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
cmap <buffer>  <Plug><cword>
...
wincmd w
argglobal
edit ~/rails_work/login/login_sorcery/config/routes.rb
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
cmap <buffer>  <Plug><cword>
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_sorcery/lib,~/rails_work/login_sorcery/vendor,~/rails_work/login_sorcery/app/models/concerns,~/rails_work/login_sorcery/app/controllers/concerns,~/rails_work/login_sorcery/app/controllers,~/rails_work/login_sorcery/app/helpers,~/rails_work/login_sorcery/app/mailers,~/rails_work/login_sorcery/app/models,~/rails_work/login_sorcery/app/jobs,~/rails_work/login_sorcery/app/*,~/rails_work/login_sorcery/app/views,~/rails_work/login_sorcery/test,~/rails_work/login_sorcery/test/unit,~/rails_work/login_sorcery/test/functional,~/rails_work/login_sorcery/test/integration,~/rails_work/login_sorcery/test/controllers,~/rails_work/login_sorcery/test/helpers,~/rails_work/login_sorcery/test/mailers,~/rails_work/login_sorcery/test/models,~/rails_work/login_sorcery/test/jobs,~/rails_work/login_sorcery/vendor/plugins/*/lib,~/rails_work/login_sorcery/vendor/plugins/*/test,~/rails_work/login_sorcery/vendor/rails/*/lib,~/rails_work/login_sorcery/vendor/rails/*/test,~/rails_work/login_sorcery,~/**,.**,~/.rbenv/rbe
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
exe '2resize ' . ((&lines * 17 + 27) / 55)
exe '3resize ' . ((&lines * 16 + 27) / 55)
tabedit config/initializers/clearance.rb
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_clearance/lib,~/rails_work/login_clearance/vendor,~/rails_work/login_clearance/app/models/concerns,~/rails_work/login_clearance/app/controllers/concerns,~/rails_work/login_clearance/app/controllers,~/rails_work/login_clearance/app/helpers,~/rails_work/login_clearance/app/mailers,~/rails_work/login_clearance/app/models,~/rails_work/login_clearance/app/jobs,~/rails_work/login_clearance/app/*,~/rails_work/login_clearance/app/views,~/rails_work/login_clearance/test,~/rails_work/login_clearance/test/unit,~/rails_work/login_clearance/test/functional,~/rails_work/login_clearance/test/integration,~/rails_work/login_clearance/test/controllers,~/rails_work/login_clearance/test/helpers,~/rails_work/login_clearance/test/mailers,~/rails_work/login_clearance/test/models,~/rails_work/login_clearance/test/jobs,~/rails_work/login_clearance/vendor/plugins/*/lib,~/rails_work/login_clearance/vendor/plugins/*/test,~/rails_work/login_clearance/vendor/rails/*/lib,~/rails_work/login_clearance/vendor/rails/*/test,
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal tabstop=2
setlocal tagcase=
setlocal tags=~/rails_work/login_clearance/tags,~/rails_work/login_clearance/tmp/tags,./tags,tags,~/.rbenv/rbenv.d/exec/gem-rehash/tags,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/2.2.0/tags,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/2.2.0/x86_64-darwin14/tags,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/tags,~/.rbenv/versions/2.2.5/lib/ruby/vendor_ruby/2.2.0/tags,~/.rbenv/versions/2.2.5/lib/ruby/vendor_ruby/2.2.0/x86_64-darwin14/tags,~/.rbenv/versions/2.2.5/lib/ruby/vendor_ruby/tags,~/.rbenv/versions/2.2.5/lib/ruby/2.2.0/tags,~/.rbenv/versions/2.2.5/lib/ruby/2.2.0/x86_64-darwin14/tags
setlocal textwidth=0
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_clearance/lib,~/rails_work/login_clearance/vendor,~/rails_work/login_clearance/app/models/concerns,~/rails_work/login_clearance/app/controllers/concerns,~/rails_work/login_clearance/app/controllers,~/rails_work/login_clearance/app/helpers,~/rails_work/login_clearance/app/mailers,~/rails_work/login_clearance/app/models,~/rails_work/login_clearance/app/jobs,~/rails_work/login_clearance/app/*,~/rails_work/login_clearance/app/views,~/rails_work/login_clearance/app/views/application,~/rails_work/login_clearance/public,~/rails_work/login_clearance/test,~/rails_work/login_clearance/test/unit,~/rails_work/login_clearance/test/functional,~/rails_work/login_clearance/test/integration,~/rails_work/login_clearance/test/controllers,~/rails_work/login_clearance/test/helpers,~/rails_work/login_clearance/test/mailers,~/rails_work/login_clearance/test/models,~/rails_work/login_clearance/test/jobs,~/rails_work/login_clearance/vendor/plugins/*/lib,~/rails_work/login_clearance/vendor/plugins/*/test,~/rails_wo
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_clearance/lib,~/rails_work/login_clearance/vendor,~/rails_work/login_clearance/app/models/concerns,~/rails_work/login_clearance/app/controllers/concerns,~/rails_work/login_clearance/app/controllers,~/rails_work/login_clearance/app/helpers,~/rails_work/login_clearance/app/mailers,~/rails_work/login_clearance/app/models,~/rails_work/login_clearance/app/jobs,~/rails_work/login_clearance/app/*,~/rails_work/login_clearance/app/views,~/rails_work/login_clearance/app/views/dashboards,~/rails_work/login_clearance/app/views/application,~/rails_work/login_clearance/public,~/rails_work/login_clearance/test,~/rails_work/login_clearance/test/unit,~/rails_work/login_clearance/test/functional,~/rails_work/login_clearance/test/integration,~/rails_work/login_clearance/test/controllers,~/rails_work/login_clearance/test/helpers,~/rails_work/login_clearance/test/mailers,~/rails_work/login_clearance/test/models,~/rails_work/login_clearance/test/jobs,~/rails_work/login_clearance/vendor/plugins/*/lib,~/rails_wor
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
