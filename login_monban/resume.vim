...
set noequalalways
set errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/login_monban
set expandtab
...
silent only
cd ~/rails_work/login/login_monban
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 Gemfile
badd +82 config/database.yml
badd +66 ~/rails_work/login_authlogic/config/database.yml
badd +48 ~/rails_work/login_authlogic/Gemfile
badd +9 .gitignore
badd +14 ~/rails_work/login_authlogic/.gitignore
badd +1 app/controllers/application_controller.rb
badd +54 vendor/bundle/ruby/2.2.0/gems/monban-1.1.0/lib/monban/controller_helpers.rb
...
setlocal path=~/rails_work/login_monban/lib,~/rails_work/login_monban/vendor,~/rails_work/login_monban/app/models/concerns,~/rails_work/login_monban/app/controllers/concerns,~/rails_work/login_monban/app/controllers,~/rails_work/login_monban/app/helpers,~/rails_work/login_monban/app/mailers,~/rails_work/login_monban/app/models,~/rails_work/login_monban/app/jobs,~/rails_work/login_monban/app/*,~/rails_work/login_monban/app/views,~/rails_work/login_monban/app/views/application,~/rails_work/login_monban/public,~/rails_work/login_monban/test,~/rails_work/login_monban/test/unit,~/rails_work/login_monban/test/functional,~/rails_work/login_monban/test/integration,~/rails_work/login_monban/test/controllers,~/rails_work/login_monban/test/helpers,~/rails_work/login_monban/test/mailers,~/rails_work/login_monban/test/models,~/rails_work/login_monban/test/jobs,~/rails_work/login_monban/vendor/plugins/*/lib,~/rails_work/login_monban/vendor/plugins/*/test,~/rails_work/login_monban/vendor/rails/*/lib,~/rails_work/login_monban/vendor/rail
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_monban/lib,~/rails_work/login_monban/vendor,~/rails_work/login_monban/app/models/concerns,~/rails_work/login_monban/app/controllers/concerns,~/rails_work/login_monban/app/controllers,~/rails_work/login_monban/app/helpers,~/rails_work/login_monban/app/mailers,~/rails_work/login_monban/app/models,~/rails_work/login_monban/app/jobs,~/rails_work/login_monban/app/*,~/rails_work/login_monban/app/views,~/rails_work/login_monban/test,~/rails_work/login_monban/test/unit,~/rails_work/login_monban/test/functional,~/rails_work/login_monban/test/integration,~/rails_work/login_monban/test/controllers,~/rails_work/login_monban/test/helpers,~/rails_work/login_monban/test/mailers,~/rails_work/login_monban/test/models,~/rails_work/login_monban/test/jobs,~/rails_work/login_monban/vendor/plugins/*/lib,~/rails_work/login_monban/vendor/plugins/*/test,~/rails_work/login_monban/vendor/rails/*/lib,~/rails_work/login_monban/vendor/rails/*/test,~/rails_work/login_monban,~/**,.**,~/.rbenv/rbenv.d/exec/gem-rehash,~/.r
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
exe '3resize ' . ((&lines * 12 + 27) / 55)
exe '4resize ' . ((&lines * 12 + 27) / 55)
tabedit app/views/users/new.html.erb
set splitbelow splitright
wincmd _ | wincmd |
split
wincmd _ | wincmd |
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_monban/lib,~/rails_work/login_monban/vendor,~/rails_work/login_monban/app/models/concerns,~/rails_work/login_monban/app/controllers/concerns,~/rails_work/login_monban/app/controllers,~/rails_work/login_monban/app/helpers,~/rails_work/login_monban/app/mailers,~/rails_work/login_monban/app/models,~/rails_work/login_monban/app/jobs,~/rails_work/login_monban/app/*,~/rails_work/login_monban/app/views,~/rails_work/login_monban/app/views/users,~/rails_work/login_monban/app/views/application,~/rails_work/login_monban/public,~/rails_work/login_monban/test,~/rails_work/login_monban/test/unit,~/rails_work/login_monban/test/functional,~/rails_work/login_monban/test/integration,~/rails_work/login_monban/test/controllers,~/rails_work/login_monban/test/helpers,~/rails_work/login_monban/test/mailers,~/rails_work/login_monban/test/models,~/rails_work/login_monban/test/jobs,~/rails_work/login_monban/vendor/plugins/*/lib,~/rails_work/login_monban/vendor/plugins/*/test,~/rails_work/login_monban/vendor/rails/*
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
wincmd w
argglobal
edit app/controllers/dashboards_controller.rb
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
cmap <buffer>  <Plug><cword>
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_monban/lib,~/rails_work/login_monban/vendor,~/rails_work/login_monban/app/models/concerns,~/rails_work/login_monban/app/controllers/concerns,~/rails_work/login_monban/app/controllers,~/rails_work/login_monban/app/helpers,~/rails_work/login_monban/app/mailers,~/rails_work/login_monban/app/models,~/rails_work/login_monban/app/jobs,~/rails_work/login_monban/app/*,~/rails_work/login_monban/app/views,~/rails_work/login_monban/app/views/dashboards,~/rails_work/login_monban/app/views/application,~/rails_work/login_monban/public,~/rails_work/login_monban/test,~/rails_work/login_monban/test/unit,~/rails_work/login_monban/test/functional,~/rails_work/login_monban/test/integration,~/rails_work/login_monban/test/controllers,~/rails_work/login_monban/test/helpers,~/rails_work/login_monban/test/mailers,~/rails_work/login_monban/test/models,~/rails_work/login_monban/test/jobs,~/rails_work/login_monban/vendor/plugins/*/lib,~/rails_work/login_monban/vendor/plugins/*/test,~/rails_work/login_monban/vendor/ra
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
