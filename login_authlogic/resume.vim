...
set noequalalways
set errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/authlogic
set expandtab
...
set shortmess=aoO
badd +55 Gemfile
badd +48 ~/rails_work/auth_six/Gemfile
badd +64 config/database.yml
badd +13 config/Schemafile
badd +1 config/routes.rb
badd +1 app/models/user.rb
badd +1 app/controllers/application_controller.rb
badd +15 .gitignore
badd +11 app/controllers/user_controller.rb
badd +1 app/views/user/new.html.slim
badd +11 app/views/user/new.slim
badd +11 app/views/user/new.html
badd +1 app/controllers/users_controller.rb
badd +7 app/views/users/new.html.slim
badd +1 app/views/users/new.html
badd +1 app/models/user_session.rb
badd +1 app/controllers/user_sessions_controller.rb
badd +8 app/views/user_sessions/new.html.slim
badd +402 ~/.vimrc
...
setlocal path=~/rails_work/authlogic/lib,~/rails_work/authlogic/vendor,~/rails_work/authlogic/app/models/concerns,~/rails_work/authlogic/app/controllers/concerns,~/rails_work/authlogic/app/controllers,~/rails_work/authlogic/app/helpers,~/rails_work/authlogic/app/mailers,~/rails_work/authlogic/app/models,~/rails_work/authlogic/app/jobs,~/rails_work/authlogic/app/*,~/rails_work/authlogic/app/views,~/rails_work/authlogic/app/views/application,~/rails_work/authlogic/public,~/rails_work/authlogic/test,~/rails_work/authlogic/test/unit,~/rails_work/authlogic/test/functional,~/rails_work/authlogic/test/integration,~/rails_work/authlogic/test/controllers,~/rails_work/authlogic/test/helpers,~/rails_work/authlogic/test/mailers,~/rails_work/authlogic/test/models,~/rails_work/authlogic/test/jobs,~/rails_work/authlogic/vendor/plugins/*/lib,~/rails_work/authlogic/vendor/plugins/*/test,~/rails_work/authlogic/vendor/rails/*/lib,~/rails_work/authlogic/vendor/rails/*/test,~/rails_work/authlogic,~/**,.**,~/.rbenv/rbenv.d/exec/gem-rehash,~/.r
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/authlogic/lib,~/rails_work/authlogic/vendor,~/rails_work/authlogic/app/models/concerns,~/rails_work/authlogic/app/controllers/concerns,~/rails_work/authlogic/app/controllers,~/rails_work/authlogic/app/helpers,~/rails_work/authlogic/app/mailers,~/rails_work/authlogic/app/models,~/rails_work/authlogic/app/jobs,~/rails_work/authlogic/app/*,~/rails_work/authlogic/app/views,~/rails_work/authlogic/test,~/rails_work/authlogic/test/unit,~/rails_work/authlogic/test/functional,~/rails_work/authlogic/test/integration,~/rails_work/authlogic/test/controllers,~/rails_work/authlogic/test/helpers,~/rails_work/authlogic/test/mailers,~/rails_work/authlogic/test/models,~/rails_work/authlogic/test/jobs,~/rails_work/authlogic/vendor/plugins/*/lib,~/rails_work/authlogic/vendor/plugins/*/test,~/rails_work/authlogic/vendor/rails/*/lib,~/rails_work/authlogic/vendor/rails/*/test,~/rails_work/authlogic,~/**,.**,~/.rbenv/rbenv.d/exec/gem-rehash,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/2.2.0,~/.rbenv/versions/2.2.5/lib/ru
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal nodiff
setlocal equalprg=
setlocal errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/login_authlogic
setlocal expandtab
if &filetype != 'ruby'
setlocal filetype=ruby
endif
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_authlogic/lib,~/rails_work/login_authlogic/vendor,~/rails_work/login_authlogic/app/models/concerns,~/rails_work/login_authlogic/app/controllers/concerns,~/rails_work/login_authlogic/app/controllers,~/rails_work/login_authlogic/app/helpers,~/rails_work/login_authlogic/app/mailers,~/rails_work/login_authlogic/app/models,~/rails_work/login_authlogic/app/jobs,~/rails_work/login_authlogic/app/*,~/rails_work/login_authlogic/app/views,~/rails_work/login_authlogic/app/views/dashboards,~/rails_work/login_authlogic/app/views/application,~/rails_work/login_authlogic/public,~/rails_work/login_authlogic/test,~/rails_work/login_authlogic/test/unit,~/rails_work/login_authlogic/test/functional,~/rails_work/login_authlogic/test/integration,~/rails_work/login_authlogic/test/controllers,~/rails_work/login_authlogic/test/helpers,~/rails_work/login_authlogic/test/mailers,~/rails_work/login_authlogic/test/models,~/rails_work/login_authlogic/test/jobs,~/rails_work/login_authlogic/vendor/plugins/*/lib,~/rails_wor
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal tabstop=2
setlocal tagcase=
setlocal tags=~/rails_work/login_authlogic/tags,~/rails_work/login_authlogic/tmp/tags,./tags,tags,~/.rbenv/rbenv.d/exec/gem-rehash/tags,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/2.2.0/tags,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/2.2.0/x86_64-darwin14/tags,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/tags,~/.rbenv/versions/2.2.5/lib/ruby/vendor_ruby/2.2.0/tags,~/.rbenv/versions/2.2.5/lib/ruby/vendor_ruby/2.2.0/x86_64-darwin14/tags,~/.rbenv/versions/2.2.5/lib/ruby/vendor_ruby/tags,~/.rbenv/versions/2.2.5/lib/ruby/2.2.0/tags,~/.rbenv/versions/2.2.5/lib/ruby/2.2.0/x86_64-darwin14/tags
setlocal textwidth=0
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/login_authlogic/lib,~/rails_work/login_authlogic/vendor,~/rails_work/login_authlogic/app/models/concerns,~/rails_work/login_authlogic/app/controllers/concerns,~/rails_work/login_authlogic/app/controllers,~/rails_work/login_authlogic/app/helpers,~/rails_work/login_authlogic/app/mailers,~/rails_work/login_authlogic/app/models,~/rails_work/login_authlogic/app/jobs,~/rails_work/login_authlogic/app/*,~/rails_work/login_authlogic/app/views,~/rails_work/login_authlogic/app/views/user_sessions,~/rails_work/login_authlogic/app/views/application,~/rails_work/login_authlogic/public,~/rails_work/login_authlogic/test,~/rails_work/login_authlogic/test/unit,~/rails_work/login_authlogic/test/functional,~/rails_work/login_authlogic/test/integration,~/rails_work/login_authlogic/test/controllers,~/rails_work/login_authlogic/test/helpers,~/rails_work/login_authlogic/test/mailers,~/rails_work/login_authlogic/test/models,~/rails_work/login_authlogic/test/jobs,~/rails_work/login_authlogic/vendor/plugins/*/lib,~/rails_
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
