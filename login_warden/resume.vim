...
set noequalalways
set errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/login_warden
set expandtab
...
badd +0 config/initializers/warden.rb
badd +21 ~/rails_work/login_sorcery/app/controllers/users_controller.rb
argglobal
silent! argdel *
...
setlocal path=~/rails_work/login_warden/lib,~/rails_work/login_warden/vendor,~/rails_work/login_warden/app/models/concerns,~/rails_work/login_warden/app/controllers/concerns,~/rails_work/login_warden/app/controllers,~/rails_work/login_warden/app/helpers,~/rails_work/login_warden/app/mailers,~/rails_work/login_warden/app/models,~/rails_work/login_warden/app/jobs,~/rails_work/login_warden/app/*,~/rails_work/login_warden/app/views,~/rails_work/login_warden/test,~/rails_work/login_warden/test/unit,~/rails_work/login_warden/test/functional,~/rails_work/login_warden/test/integration,~/rails_work/login_warden/test/controllers,~/rails_work/login_warden/test/helpers,~/rails_work/login_warden/test/mailers,~/rails_work/login_warden/test/models,~/rails_work/login_warden/test/jobs,~/rails_work/login_warden/vendor/plugins/*/lib,~/rails_work/login_warden/vendor/plugins/*/test,~/rails_work/login_warden/vendor/rails/*/lib,~/rails_work/login_warden/vendor/rails/*/test,~/rails_work/login_warden,~/**,.**,~/.rbenv/rbenv.d/exec/gem-rehash,~/.r
...
setlocal numberwidth=4
setlocal omnifunc=
setlocal path=~/rails_work/login_warden/lib,~/rails_work/login_warden/vendor,~/rails_work/login_warden/app/models/concerns,~/rails_work/login_warden/app/controllers/concerns,~/rails_work/login_warden/app/controllers,~/rails_work/login_warden/app/helpers,~/rails_work/login_warden/app/mailers,~/rails_work/login_warden/app/models,~/rails_work/login_warden/app/jobs,~/rails_work/login_warden/app/*,~/rails_work/login_warden/app/views,~/rails_work/login_warden/test,~/rails_work/login_warden/test/unit,~/rails_work/login_warden/test/functional,~/rails_work/login_warden/test/integration,~/rails_work/login_warden/test/controllers,~/rails_work/login_warden/test/helpers,~/rails_work/login_warden/test/mailers,~/rails_work/login_warden/test/models,~/rails_work/login_warden/test/jobs,~/rails_work/login_warden/vendor/plugins/*/lib,~/rails_work/login_warden/vendor/plugins/*/test,~/rails_work/login_warden/vendor/rails/*/lib,~/rails_work/login_warden/vendor/rails/*/test,~/rails_work/login_warden,~/**,.**
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal tabstop=2
setlocal tagcase=
setlocal tags=~/rails_work/login_warden/tags,~/rails_work/login_warden/tmp/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal undofile
setlocal undolevels=-123456
